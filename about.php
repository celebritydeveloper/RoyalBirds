    ...
    <nav class="navbar navbar-expand-md navbar-light bg-faded">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="about.php" class="nav-link active">About</a>
        ...
        <div class="row pb-30">
            <div class="col-sm-4 single-package-wrapper rpb">
                <div class="singel-packages">
                    ...
                    <div class="packages-title" style="text-align:center;">
                        <div class="title-wrapper">
                            <h3><a href="#" title="">Inverlochy Castle Hotel</a></h3>
                            <p>2 days, 3 Nights start from </p>
                        </div>
                         <ul class="social_options1">
                            <li style="display:inline;"><a href="#" title=""><i class="fab fa-facebook fa-lg"></i></a></li> 
                            <li style="display:inline;"><a href="#" title=""><i class="fab fa-google fa-lg"></i></a></li>          
                        </ul>  
                    </div>
                </div>   
            </div>            
